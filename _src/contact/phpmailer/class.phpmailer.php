...
class PHPMailer
{
     ...
     * @type string
     */
    public $From = 'reachout@mncarpenter.mobi';

    /**
     * The From name of the message.
     * @type string
     */
    public $FromName = 'Mobi Contact Reach Out';
     ...
     * @type string
     */
    public $Host = 'p3plcpnl0990.prod.phx3.secureserver.net:465';
     ...
     * @type string
     */
    public $Username = 'reach@mncarpenter.mobi';

    /**
     * SMTP password.
     * @type string
     */
    public $Password = '..S!G[rBEO^w';
